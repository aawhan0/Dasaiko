...
PAPER_CATALOG: tuple[PaperCatalogEntry, ...] = (
    PaperCatalogEntry(
        ...
        starter_question="Why did the authors replace recurrence with self-attention in the Transformer?",
    ...
    PaperCatalogEntry(
        ...
        starter_question="What problem do residual connections solve when training very deep networks?",
    ...
    PaperCatalogEntry(
        ...
        starter_question="Why does RAG retrieve external documents instead of relying only on the language model?",
    ...
    PaperCatalogEntry(
        ...
        starter_question="How does BERT's bidirectional pre-training help it understand language context?",
    ...
    PaperCatalogEntry(
        ...
        starter_question="What made AlexNet effective enough to dramatically improve ImageNet performance?",
    ...
    PaperCatalogEntry(
        ...
        starter_question="How does DQN use a neural network to estimate which action should be taken?",
    ...
    PaperCatalogEntry(
        ...
        starter_question="How does Vision Transformer turn an image into a sequence that a Transformer can process?",
    ...
    PaperCatalogEntry(
        ...
        starter_question="What does GPT-3 demonstrate about scaling language models for few-shot learning?",
