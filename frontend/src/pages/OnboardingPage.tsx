      ...
      <div className="relative z-10 flex min-h-screen flex-col px-5 py-7 sm:px-8 lg:px-12">
        ...
        <section className="mx-auto flex w-full max-w-3xl flex-1 items-center justify-center py-12">
          <div className="w-full">
            {step === 0 && <div className="text-center"><div className="mx-auto mb-8 flex h-16 w-16 items-center justify-center rounded-2xl border border-primary/20 bg-primary/[0.08] shadow-glow"><Sparkles className="h-7 w-7 text-primary-300" /></div><p className="mb-4 text-[10px] font-bold uppercase tracking-[0.22em] text-primary-300">Your research journey starts here</p><h1 className="font-heading text-4xl font-extrabold tracking-[-0.05em] text-white sm:text-6xl">Let's make Dasaiko yours.</h1><p className="mx-auto mt-5 max-w-xl text-sm font-medium leading-7 text-zinc-500 sm:text-base">A few quick choices help us shape your first AI/ML research experience around what you actually want to learn.</p></div>}
